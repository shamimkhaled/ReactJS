import { Badge, Box, Button, Container, HStack, Image, Progress, Radio, RadioGroup, Text, VStack } from '@chakra-ui/react'
...
const CoinsDetails = () => {
  const [coin, setCoinDetails] = useState({});
  ...
  const btnArray = ["24h", "7d", "14d", "30d", "60d", "200d", "1y", "max"];
        ...
        <Container maxW={'container.xl'} >
              {
                  ...
                  <>
                     ...
                     <VStack spacing={'4'} p={'16'} alignItems={'flex-start'}>
                          <Text fontSize={'small'} alignSelf={'center'}opacity={'0.7'} >Last Update on{" "}
...
//CustomBar for coin progress bar
